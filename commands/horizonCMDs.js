...
function stats(msg) {
  https.get(url, function(res) {
    msg.channel.send("Horizon's III server is up and running!")
  }).on('error', function(e) {
    msg.channel.send("Horizon's III server is offline");
  });
}
...
var url = "https://api.minetools.eu/ping/192.99.160.99/25560";
